  ...
  <div class="combine-main">
    ...
    <p class="admin-content__section-desc  combine-button">
      ...
      <?php if($questions->question_type == 1): ?>
        <a href="<?php echo e(route('manageAnswers',$questions->id)); ?>" class="white-button">Answers</a>
        <a href="<?php echo e(route('questionServeyResult', $questions->id)); ?>" class="white-button">View Report</a>
...
<div class="admin-content__stats u-background-white">
  ...
  <div class="admin-content__stat">
    ...
    <span class="admin-content__stat-number"><?php if($engagementCount >=1 ): ?> <?php echo e($engagementCount); ?> <?php else: ?> N/A <?php endif; ?></span> </div>
  <!-- /admin-content__stat-->
  <div class="admin-content__stat">
...
<div class="col-md-12 user-pad">
    <section class="admin-content__section">
      ...
      <div class="table-main-scroll"><table class="admin-content__table">
        ...
        <tbody>
            <?php $__currentLoopData = $user_enganged; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="clickable-row"> 
                    <td style="display:none"></td>
			        <td>
                        <img src="<?php echo e(asset('images/')); ?>/<?php echo e($user->user->avatar_url); ?>" class="category-listing-icon">
                        <?php echo e($user->user->handle); ?>
                    ...
                    <td class=""> 
                        <a href="/players/<?php echo e($user->user->handle); ?>" target="_blank" alt="<?php echo e($user->user->handle); ?>"> <i class="fa fa-caret-down" aria-hidden="true"></i></button>
                        </a>
                    </td>
                </tr>
...
<div id="settingMultipleChoiceModal" class="modal modal-box fade" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <form method="post" action="<?php echo e(route('questionSetting')); ?>">
