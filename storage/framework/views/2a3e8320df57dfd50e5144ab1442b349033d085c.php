...
<div id="open-import" class="modal-box">
  ...
  <div class="modal-body">
	...
	<a href="<?php echo e(asset('csv/sample.csv')); ?>" name="sample" class="debate-btn" download>Download sample CSV</a>
	</form>
  </div>
</div>
...
<section id="first-tab-group" class="tabgroup">
        ...
        <th class="hide-col">
            ...
            <tr class="clickable-row">
                ...
                <td><a href="/partners/questions/view/<?php echo e($latest->id); ?>" alt="view question">
                <?php echo e($latest->text); ?></a>
            </td> <td>
...
<a href="/partners/questions/view/<?php echo e($latest->id); ?>" alt="view question">
                ...
                <?php echo e($latest->QuesImpressions()->count()); ?>
