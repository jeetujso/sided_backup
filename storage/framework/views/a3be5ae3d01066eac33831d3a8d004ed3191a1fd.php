...
<div class="game-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
			...
			<div class="custom-inner <?php echo e($newClass); ?>">
                <ul class="y-axis">
                    <?php
                        $interval = 5;
                        $range = 25;
                ...
                <?php if($questionDetails->allowed_other_answer == 1): ?>
                    <div class="bar">
                        <div class="value tooltips" data-original-title="<?php echo e($otherAnswersCount); ?>%" data-toggle="tooltip" data-placement="top" style="height: <?php echo e($otherAnswersCount*$heightMultipliyer); ?>%; background-color:#ff00bf;" onclick='resultDetail("Other Answer", <?php echo e($otherAnswersCount); ?>, <?php echo e(round(($otherAnswersCount / $answered)*100, 2)); ?>)'></div>
                    </div>
                <?php endif; ?>
            </div>
			</div>
