      ...
      <table cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
				<td style="padding: 20px 0; text-align: center">
					<img src="<?php echo e(asset('emails/SidedLogoOneColor_200x25.png')); ?>" width="200" height="50"  border="0">
				</td>
			</tr>
        </table>
        <!-- Email Header : END -->
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td style="padding: 40px 10px 40px 10px; text-align: center">
                                            <a href="https://beta.sided.co"><img src="<?php echo e(asset('emails/openicon.png')); ?>" width="90" height="90"  border="0" class="fluid"></a>
                                        </td>
                                    </tr>
                                    <tr>
									
                                        <td style="font-family: sans-serif; font-weight: bold; font-size: 21px; mso-height-rule: exactly; line-height: 24px; color: #333333; padding: 0 10px 10px; text-align: center;" class="center-on-narrow"><p><span style="font-family: sans-serif; font-weight: bold; font-size: 21px; mso-height-rule: exactly; line-height: 24px; color: #333333; padding: 0 10px 10px; text-align: center;" class="center-on-narrow">Hey <?php echo e(ucfirst(trans($take_a_dare_namee))); ?>,  <?php echo e(ucfirst(trans($challenger_name))); ?> has challenged you to a debate. The question on Sided is: <a href="<?php echo e(route('publicDebateShow', $debate_id)); ?>" style="color: #61dd50; text-decoration: none;"><?php echo e($question_name->name); ?></a> on <a href="https://beta.sided.co" style="color: #61dd50; text-decoration: none;">Sided.</a></span></p></td>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto">
                        ...
                        <tr>
                            <td style="border-radius: 3px; background: #61dd50; text-align: center;" class="button-td">
                                <a href="<?php echo e(route('acceptDebateChallenge')); ?>?debate_id=<?php echo e($encrypted_debate_id); ?>" style="background: #61dd50; border: 15px solid #61dd50; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
