      ...
      <table cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
				<td style="padding: 20px 0; text-align: center">
					<img src="<?php echo e(asset('emails/SidedLogoOneColor_200x25.png')); ?>" width="200" height="50" alt="alt_text" border="0">
				</td>
			</tr>
        </table>
        <!-- Email Header : END -->
        ...
        <table cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td style="padding: 40px 10px 40px 10px; text-align: center">
                                            <a href="https://beta.sided.co"><img src="<?php echo e(asset('emails/openicon.png')); ?>" width="90" height="90" alt="alt_text" border="0" class="fluid"></a>
                                        </td>
                                    </tr>
                                    <?php
                ...
                ?>
                                    <tr>
                                        <td style="font-family: sans-serif; font-weight: bold; font-size: 21px; mso-height-rule: exactly; line-height: 24px; color: #333333; padding: 0 10px 10px; text-align: center;" class="center-on-narrow"><p><span style="font-family: sans-serif; font-weight: bold; font-size: 21px; mso-height-rule: exactly; line-height: 24px; color: #333333; padding: 0 10px 10px; text-align: center;" class="center-on-narrow">Hi <?php echo e(ucfirst(trans($user->name))); ?>, do you want to start a debate about <a href="<?php echo e(route('publicDebateShow', $debate->id)); ?>" style="color: #61dd50; text-decoration: none;"><?php echo e($question_name->name); ?></a> on <a href="https://beta.sided.co" style="color: #61dd50; text-decoration: none;">Sided.</a></span></p></td>
                                    </tr>
                                    <tr>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto">
                        <tr>
                            <td style="border-radius: 3px; background: #61dd50; text-align: center;" class="button-td">
                                <a href="<?php echo e(route('publicDebateShow', $debate->id)); ?>" style="background: #61dd50; border: 15px solid #61dd50; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
...
contact@sided.co</span><br><span class="mobile-link--footer">(888) 453-4554</span>
                    <br><br> 
                    <a href="#" style="color:#888888; text-decoration:underline;">manage communication preferences</a>
                </td>
            </tr>
        </table>
        <!-- Email Footer : END -->
