...
<body>
        ...
        <nav class="primary-nav">
            <div class="u-container">
                <div class="primary-nav__left">
                    ...
                    <a class="primary-nav__link" href="<?php echo e(route('publicDashboardIndex')); ?>">
                        Feed
                    </a>
                    <a class="primary-nav__link" href="<?php echo e(route('publicDebateCreate')); ?>">
                        Start a New Debate
                    </a>
    ...
    <!-- Scripts -->
    <script src="<?php echo e(asset('js/app_nonlogin.js')); ?>"></script>
