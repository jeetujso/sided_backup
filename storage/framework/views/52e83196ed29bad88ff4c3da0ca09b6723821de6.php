    ...
    <div id="app">
        <nav class="admin-nav">
            <header class="admin-nav__header">
                <a class="<?php echo e(Request::is('partners') ? 'admin-nav__link--active' : ''); ?>" href="<?php echo e(route('partnerQuestionActivity')); ?>">
                    <img class="admin-nav__logo" src="<?php echo e(asset('img-dist/brand/logo_white.svg')); ?>" alt="Sided Logo">
                </a>
            </header>
            <div class="topnav" id="myTopnav">
            <div class="admin-nav__user">
                
                <a href="<?php echo e(route('proprofile.edit', auth()->user()->id )); ?>" class="profile-img-click">
                    <img class="u-img-avatar" src="<?php echo e(asset('images')); ?>/<?php echo e(auth()->user()->avatar_url); ?>" alt="<?php echo e(auth()->user()->name); ?>">
                </a>

                <p><strong><a href="<?php echo e(route('proprofile.edit', auth()->user()->id )); ?>"><?php echo e(auth()->user()->name); ?></a></strong></p>
                
  <div class="wrapper">
    <p>On Air</p>
  <label class="switch">
  <?php if(Auth::user()->go_online == 'false'): ?>
...
<a class="admin-nav__link <?php echo e(Request::is('*partners/advertiser*') ? 'admin-nav__link--active' : ''); ?>" href="<?php echo e(route('partnerAdvertiserIndex')); ?>">Advertiser</a>
                ...
                <a class="admin-nav__link <?php echo e(Request::is('*partners/contests*') ? 'admin-nav__link--active' : ''); ?>" href="<?php echo e(route('partnerContestIndex')); ?>">Contests</a>
                <a class="admin-nav__link <?php echo e(Request::is('*partners/Events*') ? 'admin-nav__link--active' : ''); ?>" href="<?php echo e(route('partnerEventIndex')); ?>">Events</a>
            </div>
            <hr class="admin-nav__divider">
            <div class="admin-nav__section">
                <a class="admin-nav__link <?php echo e(Request::is('*players/proprofile*') ? 'admin-nav__link--active' : ''); ?>" href="<?php echo e(route('proprofile.edit', auth()->user()->id )); ?>">
                    Account Settings
                </a>
                ...
                <!-- <a class="admin-nav__link <?php echo e(Request::is('partners') ? 'admin-nav__link--active' : ''); ?>" href="#">
                    Sided Overview
                </a>
                <a class="admin-nav__link <?php echo e(Request::is('*partners/questions/supportcenter*') ? 'admin-nav__link--active' : ''); ?>" href="<?php echo e(route('partnerQuestionsupport')); ?>">
                    Support Center
                </a> -->
        ...
        <main class="admin-content">
            ...
            <?php endif; ?> 
			<?php if(Session::has('errorcsv')): ?>
                <div class="flash-msg errorcsv"><?php echo e(Session::get('errorcsv')); ?></div>
            <?php endif; ?>
...
<script>
    	$('.switch input').click(function(){
        	...
        	if($(this).val() == "true"){
                ...
                $.ajax({
                    'type': 'POST',
                    'url': "<?php echo e(route('publicgoOnline', 'false')); ?>",
                ...
                $.ajax({
                    'type': 'POST',
                    'url': "<?php echo e(route('publicgoOnline', 'true')); ?>",
                    'data': {'go_online': 'true'},
                    success: function(res){
                        $(".prosetting").html('<p>'+res.response+'</p>');
                        $(".prosetting").css('display','block');
