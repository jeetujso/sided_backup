...
<div class="game-wrapper graph-wrapper @if($hasServeyAns == 0) answer-show @endif">
    <!--game-wrapper--->
    <div class="row">
        <div class="col-lg-12">
            <!--custom chart start-->
...
<?php if(isset($serveyResults)){
			...
			<td>
                ...
                @if($questionDetails->allowed_other_answer == 1)
                    <div class="bar">
                        <div class="value tooltips" data-original-title="{{ $otherAnswersCount*$heightMultipliyer }}%; background-color:#ff00bf;" onclick='resultDetail("Other Answer", {{ $otherAnswersCount}}, {{ round(($otherAnswersCount / $answered)*100, 2) }})'></div>
                    </div>
                @endif
            </td>
			</tr>
