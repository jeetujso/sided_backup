...
<main class="game-wrapper">
	<section class="player-profile">
		<header class="player-profile__header u-text-center" @if(!empty($user->background_img)) style='background-image: url("{{ asset('images/pro_background') }}/{{ $user->background_img }}")' @endif >
						        ...
						        <li>
						            <span>
						            	<a href="{{ route('publicContestClick', $contest->id) }}" target="_blank" class="contest-img">
						            		<img class="lazy" data-original="{{ route('publicContestImpression', $contest->id) }}"/>
						            	</a>
						            </span>
						            <span>
