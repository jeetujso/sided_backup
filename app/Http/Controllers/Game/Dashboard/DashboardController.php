    ...
    public function loadDataAjax(Request $request)
    {
        ...
        <div class="debate-preview__header">
            ...
            $output .= '<div id="remove-row">
							...
							<span style="display:none" id="no-more" data-id="{{ $question->id }}" class="debate-btn nounderline btn-block mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" > Load More </span>
                        </div>';
